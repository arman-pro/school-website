                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="p-1">
                                <a href="{{route('admin.officer')}}?page=governing-body" class="btn btn-sm btn-success">Add New</a>
                            </div>
                            @if (session('delete'))
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <div class="d-inline-block">
                                                {{-- update button --}}
                                                <a href="{{ route('admin.officer.edit', ['id'=>$officer->id]) }}?page=governing-body" class="btn btn-sm btn-info">Update</a>
                                                {{-- delete button --}}
