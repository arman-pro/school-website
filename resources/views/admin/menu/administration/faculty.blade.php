...
@section('title', 'Faculty Member')
@section('content')
<div class="page-title">
    <h5>Facluty Member</h5>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="p-1">
                                <a href="{{route('admin.officer')}}?page=faculty-member" class="btn btn-sm btn-success">Add New</a>
                            </div>
                            @if (session('delete'))
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <div class="d-inline-block">
                                                {{-- update button --}}
                                                <a href="{{ route('admin.officer.edit', ['id'=>$officer->id]) }}?page=faculty-member" class="btn btn-sm btn-info">Update</a>
                                                {{-- delete button --}}
